...
Nicotine is a graphical client for Soulseek which I have chosen to use. It is a free and open source (we <3 FOSS) client that provides a clean and modern UI that can be used to operate Soulseek. I have provided a screenshot of my own application below.
<CustomImage src="https://github.com/michael-kudrik/BlogPosts/blob/main/images/nicotine%20example.png" alt="Nicotine+ UI"/>
Note the following:
