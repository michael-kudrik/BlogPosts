...
<CustomImage src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/Music1/firstLight.jpeg" alt="First Light Cover" />

I forgot to add this one, so I came back to add later on. This is unforgetably my first true introduction to City Pop, and therefore holds a special place. Just to put in perspective how good this album is, I have 4/8 of the songs liked on spotify. This means that on top of it being a great album, half of the songs are so good that I yearned for more. 
